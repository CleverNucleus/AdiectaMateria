 ...
 * @license Apache 2.0
 */
public class ItemInfiniteLiquidLava extends Item implements IModel {
	
	public static String var0;
	private Block var1;
	public static Item var2;
	
	public ItemInfiniteLiquidLava(String par0, String par1) {
            ...
            if(!par0.isBlockModifiable(par1, var4)) {
                ...
                if(!par1.canPlayerEdit(var4.offset(var3.sideHit), var3.sideHit, var2)) {
                    ...
                    if(lim1 == Material.LAVA && ((Integer)lim0.getValue(BlockLiquid.LEVEL)).intValue() == 0) {
                        ...
                        return new ActionResult<ItemStack>(EnumActionResult.SUCCESS, this.fillBucket(var2, par1, Objects.ITEM_INFINITE_LAVA));
                ...
                if(!par1.canPlayerEdit(var6, var3.sideHit, var2)) {
                    ...
                    return !par1.capabilities.isCreativeMode ? new ActionResult(EnumActionResult.SUCCESS, new ItemStack(Objects.ITEM_INFINITE_LAVA)) : new ActionResult(EnumActionResult.SUCCESS, var2);
                } else {
                    return new ActionResult<ItemStack>(EnumActionResult.FAIL, var2);
                }
            }
