...
public class ItemInfiniteLiquid extends Item implements IModel {
        ...
        if(var3 == null) {
            ...
            if(!par0.isBlockModifiable(par1, var4)) {
                ...
                if(!par1.canPlayerEdit(var4.offset(var3.sideHit), var3.sideHit, var2)) {
                    ...
                    if(lim1 == (var0 == Util.ITEM_INFINITE_LAVA ? Material.LAVA : Material.WATER) && ((Integer)lim0.getValue(BlockLiquid.LEVEL)).intValue() == 0) {
                        ...
                        return new ActionResult<ItemStack>(EnumActionResult.SUCCESS, this.fillBucket(var2, par1, (var0 == Util.ITEM_INFINITE_LAVA ? Objects.ITEM_INFINITE_LAVA : Objects.ITEM_INFINITE_WATER)));
                    } else if(lim1 == (var0 == Util.ITEM_INFINITE_LAVA ? Material.LAVA : Material.WATER) && ((Integer)lim0.getValue(BlockLiquid.LEVEL)).intValue() == 0) {
                        par1.playSound(SoundEvents.ITEM_BUCKET_FILL, 1.0F, 1.0F);
                        par0.setBlockState(var4, Blocks.AIR.getDefaultState(), 11);
                        par1.addStat(StatList.getObjectUseStats(this));
                ...
                if(!par1.canPlayerEdit(var6, var3.sideHit, var2)) {
                    ...
                    return !par1.capabilities.isCreativeMode ? new ActionResult(EnumActionResult.SUCCESS, new ItemStack(var0 == Util.ITEM_INFINITE_LAVA ? Objects.ITEM_INFINITE_LAVA : Objects.ITEM_INFINITE_WATER)) : new ActionResult(EnumActionResult.SUCCESS, var2);
                } else {
                    return new ActionResult<ItemStack>(EnumActionResult.FAIL, var2);
                }
            }
    ...
    public boolean tryPlaceContainedLiquid(@Nullable EntityPlayer par0, World par1, BlockPos par2) {
        if(this.var1 == Blocks.AIR) {
            ...
            if(!par1.isAirBlock(par2) && !var9 && !var10) {
                ...
                if(par1.provider.doesWaterVaporize() && this.var1 == (var0 == Util.ITEM_INFINITE_LAVA ? Blocks.FLOWING_LAVA : Blocks.FLOWING_WATER)) {
                    int l = par2.getX();
                    int i = par2.getY();
                    int j = par2.getZ();
                    ...
                    SoundEvent var11 = (var0 == Util.ITEM_INFINITE_LAVA ? Blocks.FLOWING_LAVA : Blocks.FLOWING_WATER) != null ? SoundEvents.ITEM_BUCKET_EMPTY : SoundEvents.ITEM_BUCKET_EMPTY;
                    
                    par1.playSound(par0, par2, var11, SoundCategory.BLOCKS, 1.0F, 1.0F);
                    par1.setBlockState(par2, (var0 == Util.ITEM_INFINITE_LAVA ? Blocks.FLOWING_LAVA.getDefaultState() : Blocks.FLOWING_WATER.getDefaultState()), 11);
                }
                return true;
            }
        }
    ...
    private static class InfiniteFluidHandler implements IFluidHandlerItem {
		...
		private final FluidTankProperties var14 = new FluidTankProperties(new FluidStack((ItemInfiniteLiquid.var0 == Util.ITEM_INFINITE_LAVA ? FluidRegistry.LAVA : FluidRegistry.WATER), Fluid.BUCKET_VOLUME), Fluid.BUCKET_VOLUME);
		...
		public FluidStack drain(FluidStack par0, boolean par1) {
			if(par0.getFluid() == (ItemInfiniteLiquid.var0 == Util.ITEM_INFINITE_LAVA ? FluidRegistry.LAVA : FluidRegistry.WATER)) {
				return par0.copy();
			} else {
				return null;
			}
		...
		public FluidStack drain(int par0, boolean par1) {
			return new FluidStack((ItemInfiniteLiquid.var0 == Util.ITEM_INFINITE_LAVA ? FluidRegistry.LAVA : FluidRegistry.WATER), Math.min(par0, Fluid.BUCKET_VOLUME));
		}
