            ...
            if(!par0.isBlockModifiable(par1, var4)) {
                ...
                if(!par1.canPlayerEdit(var4.offset(var3.sideHit), var3.sideHit, var2)) {
                    ...
                    if(lim1 == Material.WATER && ((Integer)lim0.getValue(BlockLiquid.LEVEL)).intValue() == 0) {
                        ...
                        return new ActionResult<ItemStack>(EnumActionResult.SUCCESS, this.fillBucket(var2, par1, ItemUnit.INFINITE_WATER));
                ...
                if(!par1.canPlayerEdit(var6, var3.sideHit, var2)) {
                    ...
                    return !par1.capabilities.isCreativeMode ? new ActionResult(EnumActionResult.SUCCESS, new ItemStack(ItemUnit.INFINITE_WATER)) : new ActionResult(EnumActionResult.SUCCESS, var2);
                } else {
                    return new ActionResult<ItemStack>(EnumActionResult.FAIL, var2);
                }
            }
