...
public class Recipes {
	public static void registerRecipes() {
		...
		} else if(Loader.isModLoaded(Util.MODID_AE2) && !Loader.isModLoaded(Util.MODID_TC)) {
			Crafting.addShapelessRecipe(27, new ItemStack(Item.getByNameOrId("appliedenergistics2:sky_stone_block"), 1), new ItemStack(Blocks.STONE, 1, 0), new ItemStack(Items.GLOWSTONE_DUST));
			Crafting.addShapelessRecipe(28, new ItemStack(Item.getByNameOrId("appliedenergistics2:material"), 1, 0), new ItemStack(Items.QUARTZ), new ItemStack(Items.REDSTONE));
			Crafting.addShapelessRecipe(28, new ItemStack(Item.getByNameOrId("appliedenergistics2:material"), 1, 1), new ItemStack(Item.getByNameOrId("appliedenergistics2:material"), 1, 0), new ItemStack(Items.REDSTONE));
			Crafting.addShapelessRecipe(28, new ItemStack(Item.getByNameOrId("appliedenergistics2:material"), 1, 7), new ItemStack(Item.getByNameOrId("appliedenergistics2:material"), 1, 1), new ItemStack(Items.REDSTONE));
		...
		Transmuting.add(0, new Component(BlockInit.RICE_BLOCK), new Component(BlockInit.PAPER_WALL, 12, 0));
		Transmuting.add(1, new Component(Blocks.BOOKSHELF), new Component(ItemInit.BOOK, 1, 0));
		Transmuting.add(2, new Component(Blocks.GRAVEL), new Component(Items.FLINT, 2, 0));
		Transmuting.add(3, new Component(Blocks.ICE), new Component(Blocks.FLOWING_WATER));
		Transmuting.add(4, new Component(Blocks.OBSIDIAN), new Component(Blocks.FLOWING_LAVA));
		Transmuting.add(5, new Component(Blocks.DIRT), new Component(Items.CLAY_BALL, 2, 0));
		Transmuting.add(5, new Component(Blocks.GRASS), new Component(Items.CLAY_BALL, 2, 0));
		Transmuting.add(6, new Component(Blocks.STONE).addProperty(BlockStone.VARIANT, BlockStone.EnumType.STONE), new Component(Blocks.COBBLESTONE));
		Transmuting.add(6, new Component(Blocks.COBBLESTONE), new Component(Blocks.STONE).addProperty(BlockStone.VARIANT, BlockStone.EnumType.STONE));
		Transmuting.add(7, new Component(Blocks.SAND).addProperty(BlockSand.VARIANT, BlockSand.EnumType.RED_SAND), new Component(Blocks.SOUL_SAND));
		Transmuting.add(7, new Component(Blocks.SOUL_SAND), new Component(Blocks.NETHERRACK));
		Transmuting.add(7, new Component(Blocks.NETHERRACK), new Component(Blocks.SAND).addProperty(BlockSand.VARIANT, BlockSand.EnumType.RED_SAND));
		Transmuting.add(8, new Component(Blocks.RED_MUSHROOM), new Component(Blocks.BROWN_MUSHROOM));
		Transmuting.add(8, new Component(Blocks.BROWN_MUSHROOM), new Component(Blocks.RED_MUSHROOM));
		Transmuting.add(9, new Component(Blocks.PUMPKIN), new Component(Blocks.LIT_PUMPKIN));
		Transmuting.add(9, new Component(Blocks.LIT_PUMPKIN), new Component(Blocks.PUMPKIN));
		Transmuting.add(10, new Component(Blocks.SAND).addProperty(BlockSand.VARIANT, BlockSand.EnumType.SAND), new Component(Blocks.GLASS));
		Transmuting.add(10, new Component(Blocks.GLASS), new Component(Blocks.SAND).addProperty(BlockSand.VARIANT, BlockSand.EnumType.SAND));
		Transmuting.add(11, new Component(Blocks.SAPLING).addProperty(BlockSapling.TYPE, BlockPlanks.EnumType.OAK), new Component(Blocks.SAPLING).addProperty(BlockSapling.TYPE, BlockPlanks.EnumType.DARK_OAK));
		Transmuting.add(11, new Component(Blocks.SAPLING).addProperty(BlockSapling.TYPE, BlockPlanks.EnumType.DARK_OAK), new Component(Blocks.SAPLING).addProperty(BlockSapling.TYPE, BlockPlanks.EnumType.SPRUCE));
		Transmuting.add(11, new Component(Blocks.SAPLING).addProperty(BlockSapling.TYPE, BlockPlanks.EnumType.SPRUCE), new Component(Blocks.SAPLING).addProperty(BlockSapling.TYPE, BlockPlanks.EnumType.BIRCH));
		Transmuting.add(11, new Component(Blocks.SAPLING).addProperty(BlockSapling.TYPE, BlockPlanks.EnumType.BIRCH), new Component(Blocks.SAPLING).addProperty(BlockSapling.TYPE, BlockPlanks.EnumType.JUNGLE));
		Transmuting.add(11, new Component(Blocks.SAPLING).addProperty(BlockSapling.TYPE, BlockPlanks.EnumType.JUNGLE), new Component(Blocks.SAPLING).addProperty(BlockSapling.TYPE, BlockPlanks.EnumType.ACACIA));
		Transmuting.add(11, new Component(Blocks.SAPLING).addProperty(BlockSapling.TYPE, BlockPlanks.EnumType.ACACIA), new Component(Blocks.SAPLING).addProperty(BlockSapling.TYPE, BlockPlanks.EnumType.OAK));
		Transmuting.add(12, new Component(Blocks.LOG).addProperty(BlockOldLog.VARIANT, BlockPlanks.EnumType.OAK), new Component(Blocks.LOG2).addProperty(BlockNewLog.VARIANT, BlockPlanks.EnumType.DARK_OAK));
		Transmuting.add(12, new Component(Blocks.LOG2).addProperty(BlockNewLog.VARIANT, BlockPlanks.EnumType.DARK_OAK), new Component(Blocks.LOG).addProperty(BlockOldLog.VARIANT, BlockPlanks.EnumType.SPRUCE));
		Transmuting.add(12, new Component(Blocks.LOG).addProperty(BlockOldLog.VARIANT, BlockPlanks.EnumType.SPRUCE), new Component(Blocks.LOG).addProperty(BlockOldLog.VARIANT, BlockPlanks.EnumType.BIRCH));
		Transmuting.add(12, new Component(Blocks.LOG).addProperty(BlockOldLog.VARIANT, BlockPlanks.EnumType.BIRCH), new Component(Blocks.LOG).addProperty(BlockOldLog.VARIANT, BlockPlanks.EnumType.JUNGLE));
		Transmuting.add(12, new Component(Blocks.LOG).addProperty(BlockOldLog.VARIANT, BlockPlanks.EnumType.JUNGLE), new Component(Blocks.LOG2).addProperty(BlockNewLog.VARIANT, BlockPlanks.EnumType.ACACIA));
		Transmuting.add(12, new Component(Blocks.LOG2).addProperty(BlockNewLog.VARIANT, BlockPlanks.EnumType.ACACIA), new Component(Blocks.LOG).addProperty(BlockOldLog.VARIANT, BlockPlanks.EnumType.OAK));
		Transmuting.add(13, new Component(Blocks.PLANKS).addProperty(BlockPlanks.VARIANT, BlockPlanks.EnumType.OAK), new Component(Blocks.PLANKS).addProperty(BlockPlanks.VARIANT, BlockPlanks.EnumType.DARK_OAK));
		Transmuting.add(13, new Component(Blocks.PLANKS).addProperty(BlockPlanks.VARIANT, BlockPlanks.EnumType.DARK_OAK), new Component(Blocks.PLANKS).addProperty(BlockPlanks.VARIANT, BlockPlanks.EnumType.SPRUCE));
		Transmuting.add(13, new Component(Blocks.PLANKS).addProperty(BlockPlanks.VARIANT, BlockPlanks.EnumType.SPRUCE), new Component(Blocks.PLANKS).addProperty(BlockPlanks.VARIANT, BlockPlanks.EnumType.BIRCH));
		Transmuting.add(13, new Component(Blocks.PLANKS).addProperty(BlockPlanks.VARIANT, BlockPlanks.EnumType.BIRCH), new Component(Blocks.PLANKS).addProperty(BlockPlanks.VARIANT, BlockPlanks.EnumType.JUNGLE));
		Transmuting.add(13, new Component(Blocks.PLANKS).addProperty(BlockPlanks.VARIANT, BlockPlanks.EnumType.JUNGLE), new Component(Blocks.PLANKS).addProperty(BlockPlanks.VARIANT, BlockPlanks.EnumType.ACACIA));
		Transmuting.add(13, new Component(Blocks.PLANKS).addProperty(BlockPlanks.VARIANT, BlockPlanks.EnumType.ACACIA), new Component(Blocks.PLANKS).addProperty(BlockPlanks.VARIANT, BlockPlanks.EnumType.OAK));
		Transmuting.add(14, new Component(Blocks.STONE).addProperty(BlockStone.VARIANT, BlockStone.EnumType.ANDESITE), new Component(Blocks.STONE).addProperty(BlockStone.VARIANT, BlockStone.EnumType.DIORITE));
		Transmuting.add(14, new Component(Blocks.STONE).addProperty(BlockStone.VARIANT, BlockStone.EnumType.DIORITE), new Component(Blocks.STONE).addProperty(BlockStone.VARIANT, BlockStone.EnumType.GRANITE));
		Transmuting.add(14, new Component(Blocks.STONE).addProperty(BlockStone.VARIANT, BlockStone.EnumType.GRANITE), new Component(Blocks.STONE).addProperty(BlockStone.VARIANT, BlockStone.EnumType.ANDESITE));
