...
public class Registry {
	...
	public static final Block SANDLAMP = register("sandlamp", new Block(Block.Properties.create(Material.ROCK, MaterialColor.SAND).hardnessAndResistance(2.0F, 6.0F).sound(SoundType.STONE).setLightLevel(var -> {
		return 15;
	})));
	...
	public static final Block SHOJI_PANEL = register("shoji_panel", new ShojiBlock(Block.Properties.create(Material.WOOL).hardnessAndResistance(0.3F).sound(SoundType.CLOTH).notSolid().setLightLevel(var -> {
		return 15;
	})));
	...
	public static final Item SOUL = register("soul", new Item(new Item.Properties().group(Group.INSTANCE)));
	...
	public static final Item PLANT_FIBRE = register("plant_fibre", new Item(new Item.Properties().group(Group.INSTANCE)));
	public static final Item SPINDLE = register("spindle", new SpindleItem(new Item.Properties().group(Group.INSTANCE)));
