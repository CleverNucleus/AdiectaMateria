	...
	public void spawnParticle(World par0, BlockPos par1, EnumParticleTypes par2, int par3) {
        ...
        if(var2.getMaterial() != Material.AIR) {
            ...
            for(int var = 0; var < par3; ++var) {
                ...
                var0.spawnParticle(par2, (double)((float)par1.getX() + var1.nextFloat() + 1.0F), ((double)par1.getY() + (double)var1.nextFloat() * 1.0F) + 1.0D, (double)((float)par1.getZ() + var1.nextFloat() + 1.0F), 1, d0, d1, d2, 0.05D, new int[0]);
            }
        }
	}
